...
public class SelectedPdfDownloadController {
    ...
    public ResponseEntity<InputStreamResource> citiesReport(@RequestParam("checkIds") List<Long> ids, Model model) throws IOException {
        if(ids==null){
        ...
        ByteArrayInputStream bis = PdfUtils.citiesReport(std,user); // yema pathaya ra multiple data line
