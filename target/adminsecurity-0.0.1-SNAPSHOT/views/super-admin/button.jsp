...
<head>
    ...
    <link href="views/super-admin/css/font-face.css" rel="stylesheet" media="all">
    <link href="views/super-admin/vendor/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <link href="views/super-admin/vendor/font-awesome-5/css/fontawesome-all.min.css" rel="stylesheet" media="all">
    <link href="views/super-admin/vendor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">

    <!-- Bootstrap CSS-->
    <link href="views/super-admin/vendor/bootstrap-4.1/bootstrap.min.css" rel="stylesheet" media="all">

    <!-- Vendor CSS-->
    <link href="views/super-admin/vendor/animsition/animsition.min.css" rel="stylesheet" media="all">
    <link href="views/super-admin/vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet" media="all">
    <link href="views/super-admin/vendor/wow/animate.css" rel="stylesheet" media="all">
    <link href="views/super-admin/vendor/css-hamburgers/hamburgers.min.css" rel="stylesheet" media="all">
    <link href="views/super-admin/vendor/slick/slick.css" rel="stylesheet" media="all">
    <link href="views/super-admin/vendor/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="views/super-admin/vendor/perfect-scrollbar/perfect-scrollbar.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="views/super-admin/css/theme.css" rel="stylesheet" media="all">
</head>
...
<!-- Jquery JS-->
<script src="views/super-admin/vendor/jquery-3.2.1.min.js"></script>
<!-- Bootstrap JS-->

<script src="views/super-admin/vendor/bootstrap-4.1/bootstrap.min.js"></script>
<!-- Vendor JS       -->
<script src="views/super-admin/vendor/slick/slick.min.js">
</script>
<script src="views/super-admin/vendor/wow/wow.min.js"></script>
<script src="views/super-admin/vendor/animsition/animsition.min.js"></script>
<script src="views/super-admin/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js">
</script>
<script src="views/super-admin/vendor/counter-up/jquery.waypoints.min.js"></script>
<script src="views/super-admin/vendor/counter-up/jquery.counterup.min.js">
</script>
<script src="views/super-admin/vendor/circle-progress/circle-progress.min.js"></script>
<script src="views/super-admin/vendor/perfect-scrollbar/perfect-scrollbar.js"></script>
<script src="views/super-admin/vendor/chartjs/Chart.bundle.min.js"></script>
<script src="views/super-admin/vendor/select2/select2.min.js">

</script>

<!-- Main JS-->
<script src="views/super-admin/js/main.js"></script>
