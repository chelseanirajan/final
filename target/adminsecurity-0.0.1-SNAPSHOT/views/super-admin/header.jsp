...
<body class="animsition">
    ...
    <div class="page-wrapper">
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="#">
                            <img src="${contextPath}/views/super-admin/images/icon/logo.png" alt="CoolAdmin" />
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fa fa-th-list"></i>Records</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="/super-admin/student">Students</a>
                                </li>
                                <li>
                                    <a href="/super-admin/teacher">Teachers</a>
                                </li>
                                <li>
                                    <a href="/super-admin/parent">Parents</a>
                                </li>
                                <li>
                                    <a href="/super-admin/user">Users</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="${contextPath}/super-admin/registration">Register</a>
                                </li>
                                <li>
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-calendar"></i>School Attendance</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                        ...
                        <li>
                            <a href="#">
                                <i class="far fa-check-square"></i>Online Exam</a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li>
                            <a href="#">
                                <i class="fas fa-money"></i>Pay Role</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="${contextPath}/views/super-admin/images/icon/logo.png" alt="Cool Admin" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="#">
                                <i class="zmdi zmdi-plus"></i>Pay Role</a>
                        </li>
                    </ul>
                </nav>
            </div>
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="${contextPath}/views/super-admin/images/icon/avatar-06.jpg" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="${contextPath}/views/super-admin/images/icon/avatar-04.jpg" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="${contextPath}/views/super-admin/images/icon/avatar-06.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="${contextPath}/views/super-admin/images/icon/avatar-05.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="${contextPath}/views/super-admin/images/icon/avatar-04.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="${contextPath}/views/super-admin/images/icon/avatar-01.jpg" alt="${userProfile.username}" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">${userProfile.username}</a>
                                        </div>
